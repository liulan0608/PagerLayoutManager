...
public class MainActivity extends AppCompatActivity implements PagerGridLayoutManager
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        page_indicator = (PageIndicatorView) findViewById(R.id.page_indicator);
    ...
    public void onPageSizeChanged(int pageSize) {
        ...
        page_indicator.initIndicator(pageSize);
    }
    ...
    public void onPageSelect(int pageIndex) {
        ...
        page_indicator.setSelectedPage(pageIndex);
    }
    ...
    public void addMore(View view) {
        ...
        mAdapter.addDataListAtStart(data);
    }
